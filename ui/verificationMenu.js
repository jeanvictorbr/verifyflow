...
module.exports = function generateVerificationMenu(settings) {
    ...
    const newsChannelStatus = settings?.welcome_news_channel_id ? `<#${settings.welcome_news_channel_id}>` : '❌ Não definido';
    ...
    return [
        {
            ...
            "components": [
                ...
                {
                    "type": 9,
                    "accessory": { "type": 2, "style": 1, "label": "Definir Canal", "custom_id": "verification_set_news_channel" },
                    "components": [{ "type": 10, "content": `**Botão de Novidades (URL)**\n> ${newsChannelStatus}` }]
                },
                { "type": 14, "divider": true, "spacing": 2 },
                {
                    "type": 1,
